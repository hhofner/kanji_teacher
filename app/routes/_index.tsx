    ...
    <div className="flex flex-col h-full gap-8">
      <div className="md:space-y-4 space-y-8">
        ...
        <div className="flex flex-col justify-center items-center gap-8">
          <img src="/icons/ios-1024.png" className="w-32 h-32 rounded-2xl shadow-lg" alt="Oh My Kanji icon of a kanji character brush"/>
          <p>
      ...
      <footer className="flex justify-center grow">
        <div className="h-full flex flex-col justify-end"><small>Made by 0x888fff, find me on <a href="https://mozilla.social/@hans" className=" mr-1 cursor-pointer font-bold">Mastodon</a>or<a href="https://twitter.com/hofner_pls" className="ml-1 cursor-pointer font-bold">Twitter</a></small>
        </div>
      </footer>
    </div>
  );
